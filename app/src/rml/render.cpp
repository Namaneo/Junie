...
JunieRenderInterface::JunieRenderInterface(MTY_App *app)
{
    this->app = app;
...
MTY_DrawData *JunieRenderInterface::GetData()
{
    return &this->data;
}

void JunieRenderInterface::ClearData()
{
...
void JunieRenderInterface::RenderGeometry(Vertex* vertices, int num_vertices, int* indices, int num_indices, TextureHandle texture, const Vector2f& translation)
{
    int num_commands = 1;
...
void JunieRenderInterface::EnableScissorRegion(bool enable)
{
...
void JunieRenderInterface::SetScissorRegion(int x, int y, int width, int height)
{
    this->scissor.left   = x;
    this->scissor.top    = y;
...
bool JunieRenderInterface::GenerateTexture(TextureHandle& texture_handle, const byte* source, const Vector2i& source_dimensions)
{
...
void JunieRenderInterface::ReleaseTexture(TextureHandle texture)
{
